...
<main>
  ...
  <section class="py-5 text-center container" >
    <div class="row py-lg-5" style="background-image: url('img/portadaHotel.jpg'); background-size: cover; background-position: center;">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            <img src="img/Mi proyecto.jpg" class="img-fluid" alt="...">
            <div class="card-body">
              <p class="card-text">Aqui va las descripciones</p>
